...
export default class Extension {
  ...
  public async handle<TMessageType extends MessageTypes>(id: string, type: TMessageType, request: TMessageType, port: chrome.runtime.Port): Promise<any> {
    switch (type) {
